...
int main(){
	...
	if(userInput==1)
	{
		Saving_account s1;
		int userInput1;
		cout<<"-> Welcome to your savings account : "<<endl<<"Q)Select your purpose : "<<endl<<"1.Deposit\t\t2.Withdraw"<<endl;
		label3:
		cin>>userInput1;
		if(userInput1==1)
		{
	...
	else if(userInput==2)
	{
		Current_account c1;
		int userInput2;
		cout<<"-> Welcome to your current account : "<<endl<<"Q)Select your purpose : "<<endl<<"1.Deposit\t\t2.Withdraw"<<endl;
		label4:
		cin>>userInput2;	
		if(userInput2==1)
		{
	...
	label2:
	char userChoice;
	cout<<endl<<"Q)Would you like to use more options (y/n) : ";
	cin>>userChoice;
